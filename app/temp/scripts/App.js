...
var _Join = __webpack_require__(3);
...
var Join = function () {
  function Join() {
    ...
    this.Modal = (0, _jquery2.default)(".careers-modal");
    this.openButton = (0, _jquery2.default)(".current-positions__modal-button");
    this.closeButton = (0, _jquery2.default)(".careers-modal__close");
    this.selector = (0, _jquery2.default)(".careers-form__selector");
    this.jobTitle = (0, _jquery2.default)("ul li");
    this.applyNowButton = (0, _jquery2.default)("#apply-now");
    this.events();
